...
public class RandomTree {
    ...
    public static void main(String[] args) {
        AdvanceTreeNode tree = randomTree(30);
         ...
         */
        TreePrinter<AdvanceTreeNode> printer = new TreePrinter<>(n -> nameForNumber(n.getValue()), n -> n.getLeft(), n -> n.getRight());
    ...
    public static AdvanceTreeNode randomTree(int n) {
        return randomTree(1, n);
    }

    private static AdvanceTreeNode randomTree(int firstValue, int lastValue) {
        if (firstValue > lastValue) return null;
            ...
            AdvanceTreeNode root = new AdvanceTreeNode(firstValue + leftCount);
