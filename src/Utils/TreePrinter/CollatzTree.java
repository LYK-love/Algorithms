...
public class CollatzTree {
    ...
    private static AdvanceTreeNode collatzTree(int depth) {
        return collatzTree(1, 1, depth);
    }

    private static AdvanceTreeNode collatzTree(int start, int curLength, int maxLength) {
        AdvanceTreeNode root = new AdvanceTreeNode(start);
